...
'use strict';
function file_upload(request_url, auto_upload = false, element, form_id = null, button_id = null, notify_title = null, multiple = false) {
    ...
    $(document).ready(() => {
        ...
        document.querySelector(button_id).addEventListener("click", function (e) {
            ...
            $(button_id).html('<i class="fa-spin fas fa-circle-notch"></i>');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(button_id).html($(button_id).data('label'));
