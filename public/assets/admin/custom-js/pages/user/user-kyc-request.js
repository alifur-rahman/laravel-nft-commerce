(function (window, document, $) {
    ...
    $(document).on('click', ".kyc-modal", function () {
      ...
      $.ajax({
        url: '/user/kyc-management/kyc-request-description/' + id + '/' + table_id,
        method: 'GET',
        dataType: 'json',
  ...
  function kycApproveRequest() {
    ...
    Swal.fire({
      ...
      if (willDelete.isConfirmed) {
        ...
        $.ajax({
          url: '/user/kyc-management/kyc-approve-request/' + id + '/' + table_id,
          method: 'POST',
          dataType: 'json',
  ...
  function update_profile(e) {
    ...
    $.ajax({
      url: '/user/kyc-management/kyc-request-profile-view/' + id,
      method: 'GET',
      dataType: 'json',
    //   data: {}
      success: function (data) {
