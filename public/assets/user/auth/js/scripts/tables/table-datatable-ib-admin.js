...
$(function () {
                    ...
                    if ($(__this).closest("tr").next().hasClass("description")) {
                        ...
                        if ($(__this).closest("tr").next(".description").find('.datatable-inner').length) {
                            ...
                            var dt_inner = $(__this).closest('tr').next('.description').find('.trader-list').DataTable({
                                ...
                                "lengthChange": false,
                                "dom": 'Bfrtip',
                                "ajax": { "url": "/admin/ib-management/ib-admin-report-description-inner-trader-list/" + ib_id },
                                "columns": [
                                    { "data": "name" },
                                    { "data": "email" },
                                    { "data": "deposit" },
    ...
    $(document).on("click", ".sub-ib-tab", function () {
        ...
        if ($(__this).closest('tr').find('.datatable-inner').length) {
            ...
            var dt_ajax_table = $(__this).closest('tr').find('.sub-ib').DataTable({
                ...
                "lengthChange": false,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-report-description-inner-sub-ib/" + ib_id },
                "columns": [
                    { "data": "name" },
                    { "data": "email" },
                    { "data": "deposit" },
    ...
    $(document).on("click", ".trading-deposit-tab", function () {
        ...
        if ($(__this).closest('tr').find('.datatable-inner').length) {
            ...
            var dt_ajax_table = $(__this).closest('tr').find('.trading-deposit').DataTable({
                ...
                "lengthChange": false,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-report-description-inner-trading-deposit/" + ib_id },
                "columns": [
                    { "data": "c_name" },
                    { "data": "c_email" },
                    { "data": "ib_email" },
    ...
    $(document).on("click", ".trading-withdraw-tab", function () {
        ...
        if ($(__this).closest('tr').find('.datatable-inner').length) {
            ...
            var dt_ajax_table = $(__this).closest('tr').find('.trading-withdraw').DataTable({
                ...
                "lengthChange": false,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-report-description-inner-trading-withdraw/" + ib_id },
                "columns": [
                    { "data": "c_name" },
                    { "data": "c_email" },
                    { "data": "ib_email" },
    ...
    $(document).on("click", ".self-withdraw-tab", function () {
        ...
        if ($(__this).closest('tr').find('.datatable-inner').length) {
            ...
            var dt_ajax_table = $(__this).closest('tr').find('.self-withdraw').DataTable({
                ...
                "lengthChange": false,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-report-description-inner-self-withdraw/" + ib_id },
                "columns": [
                    { "data": "txnid" },
                    { "data": "amount" },
                    { "data": "method" },
    ...
    $(document).on("click", ".ib-commission-tab", function () {
        ...
        if ($(__this).closest('tr').find('.datatable-inner').length) {
            ...
            var dt_ajax_table = $(__this).closest('tr').find('.ib-commission').DataTable({
                ...
                "lengthChange": false,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-report-description-inner-ib-commission/" + ib_id },
                "columns": [
                    { "data": "trader" },
                    { "data": "ticket" },
                    { "data": "login" },
    ...
    $(document).on("click", ".kyc-tab-fill", function () {
        ...
        if ($('.kyc').length) {
            ...
            var dt_kyc = $(this).closest('tr').find('.kyc').DataTable({
                ...
                "buttons": true,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-dt-kyc-fetch-data/" + ib_id },
                "columns": [
                    { "data": "date" },
                    { "data": "document_type" },
                    { "data": "status" },
    ...
    $(document).on("click", ".comment-tab-fill", function () {
        ...
        if ($(this).closest('tr').find('.comment').length) {
            ...
            dt_comment = $(this).closest('tr').find('.comment').DataTable({
                ...
                "buttons": true,
                "dom": 'Bfrtip',
                "ajax": { "url": "/admin/ib-management/ib-admin-dt-comment-fetch-data/" + ib_id },
                "columns": [
                    { "data": "date" },
                    { "data": "comment" },
                    { "data": "actions" },
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == false) {
                    toastr['error']('Failed To Add New Comment!', 'Comments', {
    ...
    $(document).on("submit", ".change-password-form", function (event) {
        ...
        $.ajax({
            url: '/admin/ib-management/ib-admin-change-password',
            method: 'POST',
            dataType: 'json',
            data: form_data,
            success: function (data) {
                if (data.status === true) {
                    // success toaster
                    toastr['success'](data.message, 'Password Is Changed', {
                        showMethod: 'slideDown',
                        hideMethod: 'slideUp',
                        closeButton: true,
                        tapToDismiss: false,
                    ...
                    // sending mail
                    $.ajax({
                        url: '/admin/ib-management/ib-admin-change-password-mail',
                        method: 'POST',
                        dataType: 'json',
                        data: { ib_id: data.ib_id, password: data.password },
                        success: function (inner_data) {
                            if (inner_data.status === true) {
                                toastr['success'](inner_data.message, 'IB Password', {
                                    showMethod: 'slideDown',
                                    hideMethod: 'slideUp',
                                    closeButton: true,
                                    tapToDismiss: false,
    ...
    $(document).on("click", "#set-new-password", function () {
    ...
    $(document).on("click", ".reset-transaction-password-btn", function () {
        ...
        Swal.fire({
            icon: 'warning',
            title: 'Reset Transaction Tassword!',
            html: 'Are you confirm to reset transaction password of <b>' + $(this).data('name') + '</b>',
            showCancelButton: true,
            customClass: {
                confirmButton: 'btn btn-warning',
                cancelButton: 'btn btn-danger'
            ...
            if (willDelete.isConfirmed) {
                ...
                $.ajax({
                    url: '/admin/ib-management/ib-admin-reset-password',
                    method: 'POST',
                    dataType: 'json',
                    data: { ib_id: ib_id },
                    success: function (inner_data) {
    ...
    $(document).on("click", ".reset-password-btn", function () {
        ...
        Swal.fire({
            ...
            html: 'Are you confirm to reset password of <b>' + $(this).data('name') + '</b>',
            showCancelButton: true,
            customClass: {
                confirmButton: 'btn btn-warning',
                cancelButton: 'btn btn-danger'
