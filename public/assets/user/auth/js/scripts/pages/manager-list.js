                            ...
                            var users = $(__this).closest('tr').next('.description').find('.accessible-user').DataTable({
                                ...
                                "ajax": { 
                                    "url": "/admin/manager-settings/get-manager-datatable-description-users/" + manager,
                                        "data": function (d) {
                                            return $.extend({}, d, {
                                            "traders": ($(__this).closest('tr').next('.description').find('.trader-users').is(':checked'))?$(__this).closest('tr').next('.description').find('.trader-users').val():'',
                                            "ib": ($(__this).closest('tr').next('.description').find('.ib-users').is(':checked'))?$(__this).closest('tr').next('.description').find('.ib-users').val():'',
                                            "unselected": ($(__this).closest('tr').next('.description').find('.unselected-users').is(':checked'))?$(__this).closest('tr').next('.description').find('.unselected-users').val():'',
                                        });
                                    }
                                },
                                "columns": [
