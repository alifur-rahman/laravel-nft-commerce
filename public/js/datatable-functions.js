    ...
    $.fn.fetch_data = function(options) {
            ...
            if (this.length) {
                ...
                $("#btn-reset").on("click", function(e) {
                    ...
                    $(".change-rating").closest('div').find('svg').removeClass('text-warning fas');
                    datatable.draw();
                });
                    ...
                    if (data.status == true) {
                        if ($(__this).closest("tr").next().hasClass("description")) {
                            ...
                            if (settings.icon_feather == true) {
                                ...
                                $(__this).find('.dt-toggler').addClass('fa-plus').removeClass('fa-minus');
                            }
                            ...
                            if (settings.icon_feather == true) {
                                ...
                                $(__this).find('.dt-toggler').addClass('fa-minus').removeClass('fa-plus');
                            }
                            ...
                            if (settings.description_dt == true) {
                                if ($(__this).closest('tr').next('.description').find('.trading_account').length) {
                                    ...
                                    var dt_trading_account = $(__this).closest('tr').next('.description').find('.trading_account').DataTable({
                                        ...
                                        "lengthChange": false,
                                        "dom": 'Bfrtip',
                                        "ajax": { "url": settings.url + "?op=description_table & id=" + id },
