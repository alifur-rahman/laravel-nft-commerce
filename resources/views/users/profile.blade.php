...
@section('title', 'Profile of ' . $user_data->name)
                    ...
                    <div class="author-wrapper">
                        <div class="author-inner">
                            <div class="user-thumbnail">
                                <img src="{{ AllfunctionService::userPhoto($user_data->id) }}" alt="{{ $user_data->name }}"
                            ...
                            <div class="rn-author-info-content">
                                ...
                                <div class="follow-area">
                                    <div class="follow followers">
                                        <span>{{ $likeService->followersCount($user_data->id) }}<a href="#"
                                                class="color-body">followers</a></span>
                                    </div>
                                    <div class="follow following">
                                        <span>{{ $likeService->followingCount($user_data->id) }}<a href="#"
                                                class="color-body">following</a></span>
                                    </div>
                                </div>
                                <div class="author-button-area">
                                    <span class="btn at-follw follow-button"
                                        {{ $likeService->is_follow($user_data->id) }}><i data-feather="user-plus"></i> <span
                                            class="al_fol_text">Follow</span></span>
                        ...
                        <nav class="tab-button-one">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                                    type="button" role="tab" aria-controls="nav-home" aria-selected="false">On
                                    Sale</button>
                                <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile"
                                    aria-selected="true">Owned</button>
                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact"
                                    aria-selected="false">Created</button>
                                <button class="nav-link" id="nav-liked-tab" data-bs-toggle="tab" data-bs-target="#nav-liked"
                                    type="button" role="tab" aria-controls="nav-liked"
                        ...
                        <div class="col-5 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-one no-overlay with-placeBid">
                                <div class="card-thumbnail">
                                    ...
                                    <a href="/asset-details/{{ $row->id }}" class="btn btn-primary">Place Bid</a>
                                </div>
                                <div class="product-share-wrapper">
                                    ...
                                    <div class="share-btn share-btn-activation dropdown">
                                        ...
                                        <div class="share-btn-setting dropdown-menu dropdown-menu-end">
                                            <button data_id="{{ $row->id }}" type="button"
                        ...
                        <div class="col-5 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-one no-overlay with-placeBid">
                                <div class="card-thumbnail">
                                    ...
                                    <a href="/asset-details/{{ $row->id }}" class="btn btn-primary">Place Bid nai</a>
                                </div>
                                <div class="product-share-wrapper">
                                    <div class="profile-share">
                                            @php
