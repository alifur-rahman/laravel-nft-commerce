        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <ul class="breadcrumb-list">
                    ...
                    <li class="item current">Crete a New NFT</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="create-area rn-section-gapTop">
    <div class="container">
        <form action="{{route('nft.create')}}" id="nft_create_form"  method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="upload-area">
                        ...
                        <div class="create-collection-input logo-image">
                            <div class="logo-c-image logo">
                                <img id="rbtinput1" src="{{ asset('Uploads/nft-assets/profile-01.jpg') }}"
                                    alt="Profile-NFT">
                    ...
                    <div class="form-wrapper-one row flex-wrap">
                            ...
                            <div class="col-md-12">
                                <div class="input-box pb--20">
                                    ...
                                    <input id="name" name="product_name" placeholder="e. g. `Digital Awesome Game`">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="input-box pb--20">
                                    ...
                                    <textarea id="Discription" name="description" rows="3" placeholder="e. g. “After purchasing the product you can get item...”"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="input-box pb--20">
                                    <label for="properties" class="form-label">Properties</label>
                                    <textarea id="properties" name="properties" rows="3" placeholder="e. g. “After purchasing the product you can get item...”"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-increase">
                                <div class="input-box pb--20">
                                    ...
                                    <input id="dollerValue" name="price" placeholder="e. g. `20$`">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-increase">
                                <div class="input-box pb--20 al_show_error">
                                    ...
                                    <select class="profile-edit-select" id="sale_type" name="sale_type">   
                                        <option value="1" selected>Fidex Price</option> 
                            ...
                            <div class="col-md-4 col-show d-none">
                                <div class="input-box pb--20">
                                    ...
                                    <input id="bidding_deadline" type="date" name="bidding_deadline" placeholder="e. g. `Bidding Deadline`">
                                </div>
                            </div>
                            ...
                            <div class="input-box">
                                <button type="button" class="btn btn-primary btn-large w-100" id="nft_create_btn" onclick="_run(this)" data-el="fg" data-form="nft_create_form" data-loading="<div class='spinner-border spinner-border-sm' role='status'></div>" data-file="true" data-callback="nftCreateCallBack" data-btnid="nft_create_btn">Submit Item</button>
                            </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="product-style-one no-overlay">
                    <div class="card-thumbnail">
                        <a href="product-details.html"><img src="assets/images/portfolio/portfolio-08.jpg" alt="NFT_portfolio"></a>
                    </div>
...
@section('custom-js')
    <script>
        function nftCreateCallBack(data){
            if (data.status == true) {
                notify('success', data.message, 'NFT Create Success');
                $('#nft_create_form')[0].reset();
            } else {
