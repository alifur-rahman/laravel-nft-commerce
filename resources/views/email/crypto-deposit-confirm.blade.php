                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            color: #fff;
                                            text-align: center;
                                            border-radius: 5px;">Crypto Deposit Success!</h4> 
                                            <p class="d-block">Your Deposit USD Amount : <b>${{$data['amount']}}</b></p> 
                                            <p class="d-block">Your Deposit Crypto Amount : <b>{{$data['crypto_amount']}}</b></p> 
                                            <p class="d-block">Invoice Number : <b>{{$data['invoice_id']}}</b></p> 
                                            <p class="d-block">Block Chain : <b>{{$data['block_chain']}}</b></p> 
                                            <p class="d-block">Crypto Name : <b>{{$data['crypto_name']}}</b></p> 
                                            <p class="d-block">Crypto Address : <b>{{$data['crypto_address']}}</b></p> 
