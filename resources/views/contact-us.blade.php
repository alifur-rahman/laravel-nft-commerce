...
@section('content')
    ...
    <div class="rn-contact-top-area rn-section-gapTop bg_color--5">
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-delay="150"
            ...
            <div class="row g-5">
                <div class="col-lg-6" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="connect-thumbnail">
                        <div class="left-image">
                            <img src="{{ asset('assets/user/images/contact/contact1.png') }}" alt="Nft_Profile">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="form-wrapper-one registration-area">
                        ...
                        <form id="contact_form" method="POST" action="{{ route('support.message') }}">
                            @csrf
                            <div class="mb-5">
                            ...
                            <button type="button" class="btn btn-primary mr--15" id="send_msg" onclick="_run(this)" data-el="fg" data-form="contact_form" data-loading="<div class='spinner-border spinner-border-sm' role='status'></div>" data-callback="contactCallBack" data-btnid="send_msg">Sent Message</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        function contactCallBack(data) {
            if (data.status == true) {
                ...
                notify('success', data.message, 'Message Success');
                setTimeout(function() {

                }, 1000 * 2);
            } else {
                notify('error', data.message, 'Message Failed');
