                ...
                <div class="h--100">
                    <div class="rn-about-card mt_dec--50 widge-wrapper rbt-sticky-top-adjust">
                        <div class="inner">
                            ...
                            <a href="{{route('nft.create')}}" class="btn btn-primary-alta btn-large sal-animate mt--20" data-sal="slide-up" data-sal-duration="800" data-sal-delay="150">Create Now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5">
            <div class="offset-lg-2 col-lg-4 col-md-6">
                <div class="single-counter-up text-center">
                    <h3 class="counter"><span class="odometer" data-count="{{AllfunctionService::all_nft_count()}}">00</span>
                    </h3>
                    <div class="botton-title">All NFT's</div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-counter-up text-center">
                    <h3 class="counter"><span class="odometer" data-count="{{AllfunctionService::get_all_user_count()}}">00</span>
                    </h3>
            ...
            <div class="offset-lg-2 col-lg-4 col-md-6">
                <div class="single-counter-up text-center">
                    <h3 class="counter"><span class="odometer" data-count="{{AllfunctionService::get_total_sales_count()}}">00</span>
                    </h3>
                    <div class="botton-title">Total Sales</div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-counter-up text-center">
                    <h3 class="counter"><span class="odometer" data-count="{{AllfunctionService::get_all_collection_count()}}">00</span>
                    </h3>
                    <div class="botton-title">Total Collections</div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="call-to-action-wrapper">
                                ...
                                <div class="callto-action-btn-wrapper" data-sal="slide-up" data-sal-duration="800" data-sal-delay="150">
                                    <a href="{{route('nft.create')}}" class="btn btn-primary btn-large">Create</a>
                                    <a href="{{route('contact-us')}}" class="btn btn-primary-alta btn-large">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
