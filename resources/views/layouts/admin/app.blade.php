...
<body id="kt_body" style="background-image: url()" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
                ...
                <div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
                    ...
                    <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
                        <a href="{{ route('admin.dashboard') }}">
                            <img alt="Logo" src="{{ asset('assets/admin/logo/202210111228logo-dark.png') }}" class="h-35px w-90px" />
                        </a>
                    </div>
                    <!--end::Logo-->
                    <!--begin::Nav-->
                    ...
                    <div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
                        ...
                        <div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
                            ...
                            <div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="User profile">
                                <img src="{{ AllfunctionService::userPhoto(auth()->user()->id) }}" alt="image" />
                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <img alt="Logo" src="{{ asset('assets/admin/images/avatars/avater-men.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Username-->
                                ...
                                <div class="menu-item px-5">
                                    <a class="menu-link px-5" href="{{ route('logout') }}" onclick="event.preventDefault();
                                            document.getElementById('logout-form').submit();"> <span class="menu-text">Sign Out</span>
                                    </a>
                                            ...
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link active" href="{{url('/admin/profile/profile-settings')}}">
                                                        ...
                                                        <div class="menu-item">
                                                            <div class="menu-content">
                                                                <a class="btn btn-flex btn-color-primary d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible collapsed" data-bs-toggle="collapse" href="#kt_app_sidebar_menu_dashboards_collapse" data-kt-toggle-text="Show Less">
                                                                    <span data-kt-toggle-text-target="true">Show 12
                                                                        More</span>
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    <!--begin:Menu link-->
                                                    <span class="menu-link  {{ Request::is('admin/kyc-management/*') ? 'open' : ''}}">
                                                        <span class="menu-icon">
                                                        ...
                                                        <span class="menu-title">KYC Management</span>
                                                        <span class="menu-arrow"></span>
                                                    </span>
                                                    <!--end:Menu link-->
                                                    <!--begin:Menu sub-->
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link {{ Request::is('admin/kyc-management/kyc-upload-view') ? 'active' : '' }}" href="{{ route('admin.kyc-upload-view') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">KYC Upload</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link {{ Request::is('admin/kyc-management/kyc-report') ? 'active' : '' }}" href="{{ route('kyc.management.report') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">KYC Report</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link {{ Request::is('admin/kyc-management/kyc-request') ? 'active' : '' }}" href="{{ route('kyc.management.request') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">KYC Request</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ url('admin/manage-clients') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.manage.order') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.manage.deposit') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.manage.withdraw') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <span class="menu-link">
                                                        ...
                                                        <span class="menu-title">Manage NFT</span>
                                                        <span class="menu-arrow"></span>
                                                    </span>
                                                    <!--end:Menu link-->
                                                    <!--begin:Menu sub-->
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.nft_listing') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">NFT Listing</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.nft_generator') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Generate NFT</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.create_collection') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Create Collection</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.manage_collection') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">All Collection</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ url('admin/reports/withdraw') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Withdraw Report</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ url('admin/reports/deposit') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Deposit Report</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.sales_report') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                {{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.company_settings') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                            <a class="menu-link" href="{{ route('admin.settings.social_info') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                    ...
                                    <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="text-center pt-10 mb-20">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Description-->
                                                <p class="text-gray-400 fs-4 fw-semibold mb-10">There are no customers
                                                    added yet.
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="mb-12">
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="../../demo7/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Project
                                                            Briefing</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="../../demo7/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Concept
                                                            Design</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="../../demo7/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Functional
                                                            Logics</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="../../demo7/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">HTML,
                                                            CSS Coding</a>
                                                        <span class="text-muted fw-bold">Art Director</span>
                                                    </div>
                                                    <!--end::Text-->
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="d-flex flex-column">
                                                        <a href="../../demo7/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">ReactJS
                                                            Developer</a>
                                            ...
                                            <div class="mb-12">
                                                ...
                                                <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                                    ...
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="../../demo7/dist/widgets/lists.html" class="fw-bold text-gray-800 text-hover-primary fs-6">Group
                                                            lunch celebration</a>
                                                        <span class="text-muted fw-semibold d-block">Due in 29
                                                            Days</span>
                                                    </div>
                                                    <!--end::Title-->
                                                    <!--begin::Lable-->
                                                ...
                                                <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="../../demo7/dist/widgets/lists.html" class="fw-bold text-gray-800 text-hover-primary fs-6">Navigation
                                                            optimization</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="../../demo7/dist/widgets/lists.html" class="fw-bold text-gray-800 text-hover-primary fs-6">Humbert
                                                            Bresnen</a>
                                                ...
                                                <div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="../../demo7/dist/widgets/lists.html" class="fw-bold text-gray-800 text-hover-primary fs-6">Air
                                                            B & B - Real Estate</a>
                                                        <span class="text-muted fw-semibold d-block">Due in 8
                                                            Days</span>
                                                    </div>
                                                    <!--end::Title-->
                                                    <!--begin::Lable-->
                                                ...
                                                <div class="d-flex align-items-center bg-light-primary rounded p-5 mb-7">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="../../demo7/dist/widgets/lists.html" class="fw-bold text-gray-800 text-hover-primary fs-6">B &
                                                            Q - Food Company</a>
                                                        <span class="text-muted fw-semibold d-block">Due in 6
                                                            Days</span>
                                                    </div>
                                                    <!--end::Title-->
                                                    <!--begin::Lable-->
                                                ...
                                                <div class="d-flex align-items-center bg-light-danger rounded p-5">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="flex-grow-1 me-2">
                                                        <a href="../../demo7/dist/widgets/lists.html" class="fw-bold text-gray-800 text-hover-primary fs-6">Nexa
                                                            - Next generation</a>
                                                        <span class="text-muted fw-semibold d-block">Due in 4
                                                            Days</span>
                                                    </div>
                                                    <!--end::Title-->
                                                    <!--begin::Lable-->
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="mb-12">
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-6.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Emma
                                                            Smith</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-5.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Sean
                                                            Bean</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-11.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Brian
                                                            Cox</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-23.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Dan
                                                            Wilson</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-10.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Natali
                                                            Trump</a>
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-9.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Francis
                                                            Mitcham</a>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="{{ asset('assets/admin/media/avatars/300-12.jpg') }}" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                                        <a href="../../demo7/dist/apps/projects/users.html" class="text-dark fw-bold text-hover-primary fs-6">Jessie
                                                            Clarcson</a>
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                            ...
                            <a href="../../demo7/dist/index.html" class="d-flex align-items-center">
                                <img alt="Logo" src="{{ asset('assets/admin/media/logos/demo7.svg') }}" class="h-30px" />
                            </a>
                            <!--end::Logo-->
                        </div>
                        <!--end::Wrapper-->
                        ...
                        <div class="d-flex flex-shrink-0">
                            ...
                            {{-- <div class="d-flex align-items-center ms-3">
                                ...
                                <a href="{{ route('logout') }}" class="btn btn-icon btn-danger w-40px h-40px">
                                    <a ><i class="bi bi-box-arrow-in-left"></i></a>
                                </a>
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-xxl d-flex flex-column flex-md-row flex-stack">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            <span class="text-gray-400 fw-semibold me-1">© <?php echo date('Y'); ?>Enviva.io,inc | All right Reserved</span>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                        <!--begin::Title-->
                                        <a href="../../demo7/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting
                                            with customer</a>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                        <!--begin::Title-->
                                        <a href="../../demo7/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                                <a href="../../demo7/dist/apps/projects/project.html" class="fs-6 text-hover-primary fw-bold">Finance KPI App
                                                    Guidelines</a>
                                                <!--end::Desc-->
                                                <!--begin::Number-->
                ...
                <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <!--end::User-->
                            <!--begin::Text-->
                            <div class="p-5 rounded bg-light-primary text-dark fw-semibold mw-lg-400px text-end" data-kt-element="message-text">Hey there, we’re just writing to let you know that
                    ...
                    <div class="d-flex justify-content-start mb-10">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <!--end::User-->
                            <!--begin::Text-->
                            <div class="p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start" data-kt-element="message-text">Company BBQ to celebrate the last quater achievements
    ...
    <script type="text/javascript" language="javascript" src="{{asset('js/datatable/dataTables.buttons.min.js')}}"></script>
