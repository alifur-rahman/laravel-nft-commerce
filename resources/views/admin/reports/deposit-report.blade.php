...
@section('breadcrumb')
<h1 class="text-dark fw-bold my-0 fs-2">Deposit Report</h1>
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">
        <a href="{{ url('admin/dashboard') }}" class="text-muted">Home</a>
    </li>
    <li class="breadcrumb-item text-muted">Deposit Report</li>
...
<script>
    const depositDT = $("#manage_client_table").DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{url('admin/reports/deposit')}}"+ "?action=table",
                data: function(d) {
                    return $.extend({}, d, {
