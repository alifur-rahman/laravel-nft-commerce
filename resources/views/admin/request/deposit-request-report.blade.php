...
@section('breadcrumb')
    <h1 class="text-dark fw-bold my-0 fs-2">Deposit Request Report</h1>
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">
            <a href="{{ url('admin/dashboard') }}" class="text-muted">Home</a>
        </li>
        <li class="breadcrumb-item text-muted">Deposit Request Report</li>
                        ...
                        <div class="input-group" data-date="2017/01/01" data-date-format="yyyy/mm/dd">
                            <span class="input-group-text">
                                <div class="icon-wrapper">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                <div class="mb-13 text-center">
                    <h1 class="mb-3">Deposit Request Action</h1>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body px-sm-5 mx-50 pb-5">
                ...
                <!-- form -->
                <form id="kyc_request" class="row gy-1 gx-2 mt-75" action="{{route('admin.decline-request')}}" method="POST">
                    <div class="col-12">
...
@section('custom-script')
    ...
    function kycApproveRequest() {
        ...
        if (willDelete.isConfirmed) {
            ...
            $.ajax({
            url: '/admin/manage-report/deposit-request/approve-request/' + id + '/' + table_id,
            method: 'POST',
            dataType: 'json',
    ...
    $(document).on("submit", "#kyc_request", function(event) {
        ...
        $.ajax({
            url: '/admin/manage-report/deposit-request/decline-request',
            method: 'POST',
            dataType: 'json',
            data: form_data,
            success: function(data) {
